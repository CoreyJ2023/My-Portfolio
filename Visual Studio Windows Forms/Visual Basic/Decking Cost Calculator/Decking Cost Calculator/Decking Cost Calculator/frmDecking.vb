...
Public Class frmDecking
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ...
        If IsNumeric(txtFootage.Text) Then
            ...
            Else
                ...
                MsgBox("You entered " & decFootage.ToString() & ". Enter a Positive Nmber", , "Input Error")
                txtFootage.Text = ""
                txtFootage.Focus()
            End If
        Else
    ...
    Private Sub btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        ...
        '   clears the square footage text box and the cost estimate label, reset the radio
